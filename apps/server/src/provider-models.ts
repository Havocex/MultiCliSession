...
const fallbacks: Record<AgentProvider, ProviderModel[]> = {
  ...
  copilot: [
    ...
    { id: 'claude-sonnet-5', label: 'Claude Sonnet 5', group: 'Anthropic', efforts: [], supportsFast: false },
    { id: 'claude-sonnet-4.6', label: 'Claude Sonnet 4.6', group: 'Anthropic', efforts: ['low', 'medium', 'high', 'max'], defaultEffort: 'medium', supportsFast: false },
    { id: 'claude-sonnet-4.5', label: 'Claude Sonnet 4.5', group: 'Anthropic', efforts: [], supportsFast: false },
    { id: 'claude-haiku-4.5', label: 'Claude Haiku 4.5', group: 'Anthropic', efforts: [], supportsFast: true },
    { id: 'claude-fable-5', label: 'Claude Fable 5', group: 'Anthropic', efforts: [], supportsFast: false },
    { id: 'claude-opus-5', label: 'Claude Opus 5', group: 'Anthropic', efforts: [], supportsFast: false },
    { id: 'claude-opus-4.8', label: 'Claude Opus 4.8', group: 'Anthropic', efforts: [], supportsFast: false },
    { id: 'claude-opus-4.8-fast', label: 'Claude Opus 4.8 Fast', group: 'Anthropic', efforts: [], supportsFast: true },
    { id: 'claude-opus-4.7', label: 'Claude Opus 4.7', group: 'Anthropic', efforts: [], supportsFast: false },
    { id: 'claude-opus-4.6', label: 'Claude Opus 4.6', group: 'Anthropic', efforts: [], supportsFast: false },
    { id: 'claude-opus-4.5', label: 'Claude Opus 4.5', group: 'Anthropic', efforts: [], supportsFast: false },
    { id: 'gpt-5.6-sol', label: 'GPT-5.6-Sol', group: 'OpenAI', efforts: [], supportsFast: false },
    { id: 'gpt-5.6-terra', label: 'GPT-5.6-Terra', group: 'OpenAI', efforts: [], supportsFast: false },
    { id: 'gpt-5.6-luna', label: 'GPT-5.6-Luna', group: 'OpenAI', efforts: [], supportsFast: false },
    { id: 'gpt-5.5', label: 'GPT-5.5', group: 'OpenAI', efforts: [], supportsFast: false },
    { id: 'gpt-5.4', label: 'GPT-5.4', group: 'OpenAI', efforts: ['none', 'minimal', 'low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium', supportsFast: false },
    { id: 'gpt-5.3-codex', label: 'GPT-5.3-Codex', group: 'OpenAI', efforts: ['low', 'medium', 'high', 'xhigh'], defaultEffort: 'medium', supportsFast: false },
    { id: 'gpt-5.4-mini', label: 'GPT-5.4 Mini', group: 'OpenAI', efforts: [], supportsFast: true },
    { id: 'gpt-5-mini', label: 'GPT-5 Mini', group: 'OpenAI', efforts: [], supportsFast: true },
    { id: 'gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro · Preview', group: 'Google', efforts: ['low', 'medium', 'high'], defaultEffort: 'medium', supportsFast: false },
    { id: 'gemini-3.6-flash', label: 'Gemini 3.6 Flash', group: 'Google', efforts: ['minimal', 'low', 'medium', 'high'], defaultEffort: 'medium', supportsFast: true },
    { id: 'gemini-3.5-flash', label: 'Gemini 3.5 Flash', group: 'Google', efforts: ['minimal', 'low', 'medium', 'high'], defaultEffort: 'medium', supportsFast: true },
    { id: 'kimi-k2.7-code', label: 'Kimi K2.7 Code', group: 'Kimi', efforts: [], supportsFast: false },
  ],
  kimi: [
    {
      id: 'kimi-code/k3',
